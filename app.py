...
if __name__ == "__main__":
    ...
    slider_color="#1a1a1a",
    slider_color_dark="#1a1a1a",
    button_primary_background_fill="#1a1a1a",
    button_primary_background_fill_hover="#0f0f0f",
    button_primary_background_fill_dark="#1a1a1a",
    button_primary_background_fill_hover_dark="#0f0f0f",
    checkbox_label_background_fill_selected="#1a1a1a",
    checkbox_label_background_fill_selected_dark="#1a1a1a",
    checkbox_background_color_selected="#1a1a1a",
    checkbox_background_color_selected_dark="#1a1a1a",
        ),
        css=css,
    )
