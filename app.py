...
if __name__ == "__main__":
    demo.launch(
        ...
        theme=gr.themes.Soft(primary_hue=gr.themes.colors.orange).set(
            block_label_background_fill="#2a1506",
            block_label_background_fill_dark="#2a1506",
            block_label_text_color="white",
            block_label_text_color_dark="white",
            slider_color="#2a1506",
            slider_color_dark="#2a1506",
            button_primary_background_fill="#2a1506",
            button_primary_background_fill_hover="#1a1a1a",
            button_primary_background_fill_dark="#2a1506",
            button_primary_background_fill_hover_dark="#1a1a1a",
            checkbox_label_background_fill_selected="#2a1506",
            checkbox_label_background_fill_selected_dark="#2a1506",
            checkbox_background_color_selected="#2a1506",
            checkbox_background_color_selected_dark="#2a1506",
        ),
        css=css,
    )